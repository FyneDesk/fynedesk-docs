...
Get up and running with FyneDesk in under 5 minutes.

## Step 1: Sign Up

Go to [app.fynedesk.io](https://app.fynedesk.io) and create your account. You'll be asked for your name, email, and a password. FyneDesk will automatically create your organization.
...
- **Support email** — Your dedicated email address for email-to-ticket (format: support-yourslug@fynedesk.io)
...
- [Set up Email to Ticket](../features/email-to-ticket.md) so customers can email you directly
- [Create Knowledge Base articles](../features/knowledge-base.md) for common questions
- [Configure your client portal](../features/client-portal.md) for customer self-service
- [Explore AI Assist](../features/ai-assist.md) to speed up ticket resolution
